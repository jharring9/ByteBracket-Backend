...
exports.LOGOS = {
    ...
    UCLA: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/UCLA_Bruins_script.svg/1280px-UCLA_Bruins_script.svg.png",
    Arizona:
    ...
    Xavier:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/d/db/Xavier_Musketeers_logo.svg/2560px-Xavier_Musketeers_logo.svg.png",
    "Utah State":
        "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Utah_State_Aggies_logo.svg/2560px-Utah_State_Aggies_logo.svg.png",
    "San Diego State":
    ...
    Missouri:
        "https://upload.wikimedia.org/wikipedia/en/2/2c/Missouri_Tigers_logo.svg",
    Nevada:
    ...
    "New Mexico":
        "https://upload.wikimedia.org/wikipedia/en/thumb/4/45/New_Mexico_Lobos_logo.svg/640px-New_Mexico_Lobos_logo.svg.png",
    Arkansas:
    ...
    "Penn State":
        "https://upload.wikimedia.org/wikipedia/en/thumb/3/3a/Penn_State_Nittany_Lions_logo.svg/800px-Penn_State_Nittany_Lions_logo.svg.png",
    "Arizona State":
    ...
    "Sam Houston State":
        "https://upload.wikimedia.org/wikipedia/en/thumb/d/de/SHSU_athletics_logo.svg/1200px-SHSU_athletics_logo.svg.png",
    Providence:
        "https://upload.wikimedia.org/wikipedia/commons/5/5f/Providence_Friars_P_script_logo.gif",
    Northwestern:
    ...
    "Nevada-Las Vegas":
        "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/UNLV_Rebels_wordmark.svg/2560px-UNLV_Rebels_wordmark.svg.png",
    ...
    "Southern Utah":
        "https://upload.wikimedia.org/wikipedia/en/thumb/e/e7/Southern_Utah_Thunderbirds_logo.svg/1200px-Southern_Utah_Thunderbirds_logo.svg.png",
    Duke: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Duke_Athletics_logo.svg/2293px-Duke_Athletics_logo.svg.png",
    Rutgers:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Rutgers_Scarlet_Knights_logo.svg/870px-Rutgers_Scarlet_Knights_logo.svg.png",
    Wisconsin:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Wisconsin_Badgers_logo.svg/2171px-Wisconsin_Badgers_logo.svg.png",
    Liberty:
        "https://upload.wikimedia.org/wikipedia/en/thumb/8/80/Liberty_Flames_logo.svg/1200px-Liberty_Flames_logo.svg.png",
    "Michigan State":
    ...
    "Central Florida":
        "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/UCF_Knights_logo.svg/2547px-UCF_Knights_logo.svg.png",
    Clemson:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Clemson_Tigers_logo.svg/1071px-Clemson_Tigers_logo.svg.png",
    "Santa Clara":
        "https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Santa_Clara_Broncos_logo.svg/1579px-Santa_Clara_Broncos_logo.svg.png",
    "West Virginia":
        "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/West_Virginia_Mountaineers_logo.svg/2180px-West_Virginia_Mountaineers_logo.svg.png",
    Illinois:
    ...
    "Ohio State":
        "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Ohio_State_Buckeyes_logo.svg/2082px-Ohio_State_Buckeyes_logo.svg.png",
    "Kent State":
        "https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/Kent_State_K.svg/2560px-Kent_State_K.svg.png",
    Cincinnati:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Cincinnati_Bearcats_logo.svg/1200px-Cincinnati_Bearcats_logo.svg.png",
    Oklahoma:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/OU-Logo.svg/1200px-OU-Logo.svg.png",
    Maryland:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Maryland_Terrapins_logo.svg/1869px-Maryland_Terrapins_logo.svg.png",
    "Southern California":
        "https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/USC_Trojans_logo.svg/686px-USC_Trojans_logo.svg.png",
    "Utah Valley":
        "https://upload.wikimedia.org/wikipedia/en/thumb/c/c8/Utah_Valley_Wolverines_logo.svg/1200px-Utah_Valley_Wolverines_logo.svg.png",
    Indiana:
    ...
    Florida:
        "https://upload.wikimedia.org/wikipedia/en/1/14/Florida_Gators_gator_logo.svg",
    ...
    Utah: "https://upload.wikimedia.org/wikipedia/commons/b/be/Utah_Utes_logo.svg",
    "Oklahoma State":
        "https://upload.wikimedia.org/wikipedia/commons/1/12/Oklahoma_State_Athletics_logo_%282001-2014%29.svg",
    Colorado:
        "https://upload.wikimedia.org/wikipedia/en/d/d3/Colorado_Buffaloes_logo.svg",
    "Seton Hall":
        "http://nwbullets.com/images/logos/Seton_Hall_Pirates_Logo.svg.png",
    "Mississipi State":
        "https://upload.wikimedia.org/wikipedia/commons/3/36/Mississippi_State_Bulldogs_logo.svg",
    Pittsburgh:
        "https://www.logolynx.com/images/logolynx/be/bef8899c2d8f85eb3cbab1c045f630f6.png",
    Kentucky:
        "https://upload.wikimedia.org/wikipedia/commons/5/5d/Kentucky_Wildcats_logo_2015.png",
    "Virginia Tech":
        "https://upload.wikimedia.org/wikipedia/commons/6/60/Virginia_Tech_Hokies_logo.svg",
    "Texas Tech":
        "https://upload.wikimedia.org/wikipedia/commons/4/4e/Texas_Tech_Athletics_logo.svg",
    "Washington State":
        "https://upload.wikimedia.org/wikipedia/en/0/07/Washington_State_Cougars_logo.svg",
    "Texas A&M":
